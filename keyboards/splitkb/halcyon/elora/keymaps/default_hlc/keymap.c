 ...
 */
    [_NAV] = LAYOUT_elora_hlc(
      ...
      _______, _______, _______, _______, S(KC_SPC), _______,                                     _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, 
      _______, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______,                                     _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
      _______, _______, _______, _______, _______, _______, _______, KC_SCRL, _______, _______, _______, KC_TAB , KC_ENT,  KC_DEL,  KC_ESC , _______,
